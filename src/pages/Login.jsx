...
function Login() {
  ...
  return (
    <>
      <Helmet>
        <title>Login | Grouppy - Social Groups, Connect, Share, Chat</title>
        <meta name="description" content="Login to Grouppy and connect with your favorite groups. Join, chat, and share memories with your community." />
        <link rel="canonical" href="https://grouppy.netlify.app/login" />
      </Helmet>
